...
// Enhanced List components with improved styling
...
const HealthBenefitsPage = () => {
  ...
  // Custom page background with subtle pattern
  const pageBackground = {
    backgroundImage: 'radial-gradient(circle at 20px 20px, rgba(234, 219, 165, 0.15) 0%, rgba(234, 219, 165, 0) 25%)',
  ...
  return (
    <ThemeProvider theme={theme}>
        ...
        <Container maxWidth="lg">
          <Fade in={true}>
            <Paper elevation={3} sx={{ 
              ...
              backgroundImage: 'linear-gradient(135deg, rgba(234, 219, 165, 0.9) 0%, rgba(215, 198, 141, 0.8) 100%)',
      ...
      {/* Breadcrumb moved here - with added left padding */}
      <Box py={1} mb={2} sx={{ 
        display: 'flex',
        justifyContent: 'flex-start',
        position: 'relative',
        zIndex: 1,
        pl: { xs: 3, sm: 4 },  // Added left padding to shift right
        maxWidth: 'lg',
