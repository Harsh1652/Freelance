...
import WaterDropIcon from '@mui/icons-material/WaterDrop'; // Add this import
...
const RedSkinPeanutPage = () => {
  const theme = useTheme();
  
  return (
    <Box sx={{ bgcolor: theme.palette.background.default, pb: 8 }}>
      <Head>
        <title>Premium Red Skin Peanuts Exporter from India | Balaji Exports</title>
        <meta name="description" content="Export-quality Red Skin Peanuts with rich flavor, high oil content, and EU-grade safety. Ideal for snacks, peanut butter, oil extraction, and animal feed." />
        <meta name="keywords" content="red skin peanuts, export quality peanuts, Indian groundnuts, peanut exporters, wholesale peanuts, organic groundnuts, bulk peanuts supplier, peanut exports India" />
        <link rel="canonical" href="https://balajiexports.com/products/bold-peanuts" />
        {/* Open Graph Tags */}
        <meta property="og:title" content="Premium Export Quality Red Skin Peanuts | Balaji Exports" />
        <meta property="og:description" content="High-quality Red Skin Peanuts from India's fertile soils. FSSAI, HACCP & ISO certified. Perfect for peanut butter, snacks & more. Global shipping available." />
        <meta property="og:type" content="product" />
        <meta property="og:url" content="https://balajiexports.com/products/red-skin-peanuts" />
        {/* Twitter Card Tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Premium Export Quality Red Skin Peanuts | Balaji Exports" />
        <meta name="twitter:description" content="Export-quality Red Skin Peanuts with rich flavor, high oil content, and EU-grade safety. Ideal for snacks, peanut butter, oil extraction, and animal feed." />
      ...
      >
        <Fade in timeout={1000}>
          ...
          >
            Premium Export Quality Red Skin Peanuts
          </Typography>
        </Fade>
      ...
      <Container component="section" aria-label="Product Introduction" maxWidth="lg" sx={{ mt: { xs: 5, md: 10 } }}>
        ...
        >
          ...
          <Grid item xs={12} md={6} sx={{ width: { md: '48%' } }}>
            ...
            >
              Premium Export Quality Red Skin Peanuts – Nutritious, Flavorful & Versatile
            </Typography>
            <Typography 
              variant="body1" 
              sx={{ 
            ...
            >
              <span style={{ fontWeight: 700 }}> Red Skin Peanuts are a premium variety of groundnuts, </span>
              These are widely appreciated for their distinctive reddish-brown skin, crunchy texture, and rich, nutty flavor. They are a powerhouse of nutrition, packed with protein, healthy fats, fiber, vitamins, and minerals, making them a popular choice for both direct consumption and industrial processing.
            </Typography>
            ...
            >
                These peanuts are commonly used in a variety of applications, from roasted snack foods to peanut butter production, confectionery items, and even oil extraction.
                Their high oil content and natural taste make them ideal for culinary use and value-added food products. 
                Additionally, after oil extraction, the peanut meal serves as a protein-rich component for animal feed.
            </Typography>
        ...
        >
          Our Red Skin Peanuts are carefully sourced from selected farms to ensure the highest quality. 
          They are processed under strict hygiene standards to retain their natural flavor, color, and nutritional value. 
          With low moisture levels and minimal foreign matter, they offer extended shelf life and are safe for global export markets.
          Whether you are looking for premium peanuts for roasting, ingredient use, or oil extraction, our Red Skin Peanuts are the perfect choice to meet your needs with quality and consistency.     
...
>
  ...
  <Container maxWidth="lg">
    ...
    >
      Red Skin peanuts are highly versatile with exceptional nutritional properties and consistent quality, 
    ...
    <Box sx={{ 
      ...
      {[
        { 
          title: "Snacks", 
          icon: "🥜", 
          desc: "Roasted, salted, or boiled for healthy snacking." 
        },
        { 
          title: "Confectionery", 
          icon: "🍫", 
          desc: "Used in chocolates, sweets, and energy bars." 
        },
        { 
          title: "Peanut Butter", 
          icon: <img src={peanutButterIcon} alt="Peanut Butter" style={{ width: 28, height: 28 }} />,
          desc: "Essential for rich, creamy peanut butter production." 
        },
        { 
          title: "Culinary Uses", 
          icon: "🍲", 
          desc: "Adds a crunchy, flavorful touch to dishes and salads." 
        },
        { 
          title: "Oil Extraction", 
          icon: <img src={groundnutOilIcon} alt="Groundnut Oil" style={{ width: 28, height: 28 }} />,
          desc: "Yields high-quality peanut oil." 
        },
        { 
          title: "Animal Feed", 
          icon: "🐄", 
          desc: "Peanut meal after oil extraction serves as a protein-rich feed." 
        }
      ].map((item, index) => (
        <Box 
          key={index} 
          sx={{ 
            display: 'flex', 
            mb: 3.5,
            alignItems: 'flex-start', // Better for multi-line text alignment
          }}
        >
          ...
          {/* Text content */}
          <Box sx={{ pt: 0.5 }}> {/* Small top padding to align with icon */}
            <Typography 
              variant="h6" 
              component="h3"
              sx={{ 
  ...
  <Box sx={{ 
    ...
    >
      {[
       { 
        title: "Nutrient-Dense & High Oil Content", 
        description: "Packed with protein, healthy fats, and 44–50% oil—ideal for nutrition and oil extraction."
      },
      { 
        title: "Premium Quality & Hygiene", 
        description: "Uniform reddish-brown skin, low moisture (≤7%), and aflatoxin-safe—processed under strict quality controls."
      },
      { 
        title: "Versatile Applications", 
        description: "Perfect for snacks, peanut butter, oil extraction, and animal feed."
      },
      ...
      <Container component="section" aria-label="Why Choose Our Products" maxWidth="lg" sx={{ my: { xs: 6, md: 10 }, px: { xs: 3, md: 4 } }}>
        <Grid container spacing={4}>
          <Grid item xs={12} md={8} sx={{ mx: 'auto' }}>
            ...
            >
              Why Choose Our Red Skin Peanuts?
            </Typography>
            ...
            >
              Partner with Balaji Exports, the top peanut export company in India, and source the highest quality red skin peanuts for your global needs. Trust our experience, quality, and commitment to deliver the best from India's fertile fields to your business.
            </Typography>
      ...
      composition: {
        ...
        items: [
          { 
            name: "Oil Content", 
            value: "44% to 50%",
            description: "Rich in healthy fats, primarily monounsaturated and polyunsaturated fatty acids, ideal for cooking oils and health products."
          },
          { 
            name: "Moisture Content", 
            value: "Maximum 7%",
            description: "Ensures longer shelf life, freshness, and resistance to fungal contamination."
          }
        ]
      },
      packaging: {
        ...
        items: [
          { 
            name: "Packaging", 
            value: "Jute Bags, Vacuum Packs, or Customized as per client requirement.",
            description: "Standard weights: 25kg, 50kg."
          }
        ]
      }
    };
