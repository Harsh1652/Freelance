    ...
    <script type="application/ld+json">
      ...
      >
        <Fade in timeout={1000}>
          ...
          >
            Premium Export Quality Long Java Peanuts
          </Typography>
        </Fade>
      ...
      <Container component="section" aria-label="Product Introduction" maxWidth="lg" sx={{ mt: { xs: 5, md: 10 } }}>
        ...
        >
          ...
          <Grid item xs={12} md={6} sx={{ width: { md: '48%' } }}>
            ...
            >
              <span style={{ fontWeight: 700 }}> Long Java Peanuts – Premium Indian Groundnuts </span>
                for Snacking & Processing Long Java Peanuts are a distinctive variety of Indian peanuts known for their elongated, oval-shaped kernels and light pink skin.
            </Typography>
