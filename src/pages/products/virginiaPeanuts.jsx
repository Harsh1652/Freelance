    ...
    <Box sx={{ bgcolor: theme.palette.background.default, pb: 8 }}>
      ...
      >
        <Fade in timeout={1000}>
          ...
          >
            Premium Export Quality Virginia Peanuts
          </Typography>
        </Fade>
    ...
    >
      ...
      <Box>
        ...
        >
          ...
          >
            Our virgina peanuts' consistent quality ensures reliable performance across all these applications, 
      ...
      <Container sx={{ mb: 4, mt: 8 }}>
        <nav aria-label="breadcrumb">
          ...
          >
            ...
            <span style={{ color: theme.palette.primary.main }}>Virgina Peanuts</span>
          </Typography>
        </nav>
      </Container>
    </Box>
    ...
    return (
      <Box sx={{ 
        ...
        <Box sx={{ textAlign: 'center', mb: 3 }}>
          ...
          >
            Our virgina peanuts meet the highest quality standards for international markets
          </Typography>
        </Box>
