    ...
    <Box sx={{ bgcolor: theme.palette.background.default, pb: 8 }}>
      ...
      >
        <Fade in timeout={1000}>
          ...
          >
            Premium Export Quality Mathadi Peanuts
          </Typography>
        </Fade>
      ...
      <Container component="section" aria-label="Product Introduction" maxWidth="lg" sx={{ mt: { xs: 5, md: 10 } }}>
        ...
        >
          ...
          <Grid item xs={12} md={6} sx={{ width: { md: '48%' } }}>
            ...
            >
                Sourced primarily from Gujarat, this variety is prized in domestic and export markets for its robust flavor, excellent roasting quality, and visually appealing size. 
                Mathadi peanuts are an ideal choice for buyers looking for quality peanuts suitable for snack manufacturing, roasting, and oil extraction.
            </Typography>
        ...
        >
          Balaji Exports supplies premium-grade Mathadi peanuts with stringent quality checks, ensuring you receive clean, uniform, and export-ready kernels perfect for global food industries and retail chains.
        </Typography>
      </Container>
