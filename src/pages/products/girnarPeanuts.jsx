...
const GirnarPeanutPage = () => {
  ...
  return (
    ...
    <Head>
      ...
      <meta 
        name="description" 
        content="Girnar 4 & 5 high oleic peanuts with 78–82% oleic acid content. Long shelf life, non-GMO, aflatoxin-controlled, and perfect for peanut oil, snacks, and health foods. Export-ready from India." 
      />

      <meta 
        name="keywords" 
        content="Girnar 4 peanuts, Girnar 5 peanuts, high oleic peanuts, long shelf life peanuts, export quality peanuts, non-GMO peanuts, peanut oil peanuts, healthy peanuts, Indian groundnuts, Balaji Exports" 
      />
      ...
      <meta 
        ...
        content="Premium Girnar 4 & 5 peanuts with high oleic acid content (78–82%). Ideal for health foods, peanut oil, peanut butter, and long shelf-life snacks. Aflatoxin-controlled and non-GMO." 
      />
      ...
      <meta 
        ...
        content="Girnar 4 and Girnar 5 peanuts from India with over 78% oleic acid. Non-GMO, aflatoxin-safe, and ideal for health-conscious export markets and oil production." 
      />
      ...
      >
        <Fade in timeout={1000}>
          ...
          >
            Premium Export Quality Girnar Peanuts
          </Typography>
        </Fade>
        ...
        >
          ...
          <Grid item xs={12} md={6} sx={{ width: { md: '48%' } }}>
            ...
            >
              ...
              varieties developed in India to meet the growing demand for healthier, long-lasting peanuts. 
              These varieties are known for their high oleic acid content (over 78%), which offers improved oxidative stability, longer shelf life, and enhanced heart-health benefits.
            </Typography>
      ...
      >
        ...
        <Container maxWidth="lg">
          ...
          >
            Girnar peanuts are highly versatile with exceptional nutritional properties and consistent quality, 
          ...
          {/* Application bullet points */}
            <Box sx={{ 
              ...
              {[
                { 
                  title: "Food Products", 
                  icon: <img src={foodIcon} alt="Food Product" style={{ width: 28, height: 28 }} />,
                  desc: "Health food and natural food products" 
                },
                { 
                  title: "Snack Manufacturing", 
                  icon: "🍿", 
                  desc: "Long shelf-life snacks and roasted peanuts" 
                },
                { 
                  title: "Oil Extraction", 
                  icon: <img src={groundnutOilIcon} alt="Groundnut Oil" style={{ width: 28, height: 28 }} />,
                  desc: "Premium peanut oil production" 
                },
                { 
                  title: "Confectionery", 
                  icon: <img src={confectionaryIcon} alt="Confectionary" style={{ width: 28, height: 28 }} />,
                  desc: "Peanut butter and confectionery manufacturing" 
                }
              ].map((item, index) => (
                <Box 
                  key={index} 
          ...
          >
            Our girnar peanuts' consistent quality ensures reliable performance across all these applications, 
    ...
    >
      {[
        { 
          ...
          description: "Over 78% oleic acid for extended shelf life and health benefits"
        },
        { 
          title: "Shelf Life", 
          description: "Up to 18 months in suitable storage conditions"
        },
        { 
          title: "Oxidative Stability", 
          description: "Ideal for frying and peanut butter industries"
        },
        { 
            title: "Taste and Flavor", 
            description: "Rich Nutty Flavor with Low Moisture Retention"
        }
