...
import { Container, Box, Typography, Button, Grid, Paper, Avatar, IconButton, SvgIcon } from "@mui/material";
...
// Update certification image imports
...
// Update key feature image imports
...
const Head = ({ children }: HeadProps) => {
  useEffect(() => {
    ...
    return () => {
      ...
      const cleanup = () => {
        const addedElements = document.querySelectorAll('meta[data-added], link[data-added], script[data-added]');
    ...
    <Box sx={{ bgcolor: theme.palette.background.default, pb: 8 }}>
      <Head> 
        ...
        <script type="application/ld+json">
          {`
          {
            ...
            "@type": "Product",
            "name": "Premium Export Quality Long Java Peanuts",
      ...
      <Container component="section" aria-label="Product Introduction" maxWidth="lg" sx={{ mt: { xs: 3, md: 5 } }}>
        ...
        >
          ...
          <Grid item xs={12} md={6} sx={{ width: { md: '48%' } }}>
            ...
            >
              Long Java peanuts are known for their distinctive elongated shape and light pink skin. They are primarily grown in Gujarat and are highly valued for their rich flavor and smooth texture.
            </Typography>
            ...
            >
                Grown primarily in Gujarat, these peanuts are carefully harvested and processed to retain their natural freshness, taste, and nutritional value.
                Unlike the more rounded traditional Java type, Long Java peanuts are slightly larger in length, making them ideal for hand-to-mouth snacking, roasting, and confectionery use. 
                They are highly regarded in Middle Eastern and Southeast Asian markets for their rich flavor and smooth texture.
            </Typography>
        ...
        >
          At Balaji Exports, we supply premium-quality Long Java peanuts that meet international safety and quality standards, ensuring satisfaction across food, retail, and manufacturing sectors.
        </Typography>
      </Container>
      ...
      >
        ...
        <Container maxWidth="lg">
          ...
          >
            Long Java peanuts are highly versatile with exceptional nutritional properties and consistent quality, 
          ...
          <Box sx={{ 
            ...
            {[
              { 
                title: "Snacks", 
                icon: "🍿", 
                desc: "Dry roasting and salted peanut snacks" 
              },
              { 
                title: "Confectionary", 
                icon: "🍫",
                desc: "Used in traditional sweets and brittle (chikki)" 
              }
            ].map((item, index) => (
              <Box 
                key={index} 
          ...
          >
            Our Long Java peanuts' consistent quality ensures reliable performance across all these applications, 
      ...
      <Container component="section" aria-label="Why Choose Our Products" maxWidth="lg" sx={{ my: { xs: 6, md: 10 }, px: { xs: 3, md: 4 } }}>
        <Grid container spacing={4}>
          <Grid item xs={12} md={8} sx={{ mx: 'auto' }}>
            ...
            >
              Why Choose Our Long Java Peanuts?
            </Typography>
            ...
            >
              Food industries requiring consistent size and flavor for premium products and international applications choose our Long Java peanuts for reliable quality.
            </Typography>
            ...
            >
              Partner with Balaji Exports, the top peanut export company in India, and source the highest quality Long Java peanuts for your global needs. Trust our experience, quality, and commitment to deliver the best from India's fertile fields to your business.
            </Typography>
            ...
            <Box sx={{ textAlign: 'center', mt: 6 }}>
              <Button 
                ...
                href="/contact"
                size="large"
                aria-label="Request a quotation for Long Java Peanuts"
                sx={{ 
      ...
      <Container sx={{ mb: 4, mt: 8 }}>
        <nav aria-label="breadcrumb">
          ...
          >
            ...
            <span style={{ color: theme.palette.primary.main }}>Long Java Peanuts</span>
          </Typography>
        </nav>
      </Container>
    </Box>
  ...
  return (
    <Box sx={{ 
      ...
      <Box sx={{ textAlign: 'center', mb: 3 }}>
        ...
        >
          Our Long Java peanuts meet the highest quality standards for international markets
        </Typography>
      </Box>
...
export default LongJavaPeanutPage; 